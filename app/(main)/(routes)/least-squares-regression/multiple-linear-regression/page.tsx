...
const MultipleLinearRegression = () => {
    ...
    const multipleLinearRegression = () => {
        ...
        let x: number[][] = math.clone(x_in).map((row) => row.map((value) => parseFloat(value)));
    ...
    const handleGetSample = () => {
        setFind('65');
        const newx_in = [['1','0','2','3','4','2','1'],['0','1','4','2','1','3','6'],['1','3','1','2','5','3','4']];
    ...
    const handleDimensionChangeV = (newDimension: number) => {
        ...
        const newX_in = Array.from(Array(dimension), () => new Array(dimensionV).fill(''));
    ...
    const handleIncrementDimensionV = () => {
        handleDimensionChangeV(dimensionV + 1);
    };
        ...
        <div className="h-full flex-1 flex-col  items-center space-y-4 p-8 md:flex">
            <Card className="w-full md:w-[705px] xl:w-[1214px]">
                ...
                <div className='flex justify-start p-4'>
                    <div className="p-4 ">
                        <Button variant="secondary" size="icon" className='mr-4' onClick={handleIncrementDimension}><Plus className='w-4 h-4'/></Button>
                        <Button variant="secondary" size="icon" onClick={handleDecrementDimension}><Minus className='w-4 h-4'/></Button>
                    </div>
                    
                    <div className='flex flex-col ml-4 gap-4'>
                        <Button variant="secondary" size="icon" className="" onClick={handleIncrementDimensionV}><Plus className='w-4 h-4'/></Button>
                        <Button variant="secondary" size="icon" onClick={handleDecrementDimensionV}><Minus className='w-4 h-4'/></Button>
                    </div>
                </div>
