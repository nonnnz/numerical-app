...
const GaussJordanMethod = () => {
    ...
    const gaussJordan = () => {
        ...
        for (let i = 0; i < n; i++) {
            ...
            vectorB[i] = removeZero(vectorB[i]); // remove trailing zeros
            solution.push({matrixA: math.clone(A), matrixB: math.clone(vectorB)});
        }

        // substitute
        let x: number[] = math.clone(vectorB);;
        ...
        <div className="h-full flex-1 flex-col  items-center space-y-4 p-8 md:flex">
            <Card className="w-full md:w-[705px] xl:w-[1214px]">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <div className='space-y-2'>
                        <CardTitle>Gauss-Jordan Method</CardTitle>
                        <CardDescription>
                            Find the solution of a system of linear equations using Gauss-Jordan Method
                        </CardDescription>
                    </div>
                    <Popover>
                ...
                <CardFooter className="flex justify-between">
                    ...
                    <div className="flex items-center">
                        ...
                        <Button onClick={gaussJordan}>Calculate</Button>
                    </div>
                </CardFooter>
            </Card>
            ...
            {result.length > 0 ? (
                <>
                    ...
                    <Card className='w-full md:w-[705px] xl:w-[1214px]'>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle>Solution by Gauss-Jordan Method</CardTitle>
                        </CardHeader>
                        <CardContent>
                            {sol.map((row, i) => (
