...
const CholeskyDecompos = () => {
    ...
    const choleskyDecompose = () => {
        ...
        const lInv: number[][] = math.transpose(l);
        console.log(lInv);
        ...
        array.push({l: math.clone(l), lInv: math.clone(lInv), a: math.clone(matrixA)});
        ...
        <div className="h-full flex-1 flex-col  items-center space-y-4 p-8 md:flex">
            <Card className="w-full md:w-[705px] xl:w-[1214px]">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <div className='space-y-2'>
                        <CardTitle>Cholesky Decomposition Method</CardTitle>
                        <CardDescription>
                            Find the solution of a system of linear equations using Cholesky Decomposition Method
                        </CardDescription>
                    </div>
                    <Popover>
                ...
                <CardFooter className="flex justify-between">
                    ...
                    <div className="flex items-center">
                        ...
                        <Button onClick={choleskyDecompose}>Calculate</Button>
                    </div>
                </CardFooter>
            </Card>
            ...
            {result.length > 0 ? (
                <>
                    ...
                    <Card className='w-full md:w-[705px] xl:w-[1214px]'>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle>Solution by Cholesky Decomposition Method</CardTitle>
                        </CardHeader>
                        <CardContent>
                            {sol.map((row, i) => (
...
export default CholeskyDecompos;
